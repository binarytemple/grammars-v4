// Generated from Erlang.g4 by ANTLR 4.4
...
public class ErlangParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'bsr'", "'bor'", "'fun'", "'=<'", "'receive'", "'{'", "'>>'", 
		"'..'", "'::'", "'='", "'bxor'", "'bnot'", "'orelse'", "'('", "','", "'/='", 
		"':-'", "'after'", "'<-'", "'band'", "'>='", "'<'", "'++'", "']'", "'=:='", 
		"'#'", "'+'", "'/'", "'catch'", "'of'", "'||'", "';'", "'<<'", "'}'", 
		"'if'", "'try'", "'rem'", "'<='", "'when'", "'andalso'", "'*'", "'bsl'", 
		"'.'", "'case'", "'->'", "'...'", "':'", "'['", "'=='", "'--'", "'|'", 
		"'>'", "'xor'", "'or'", "'!'", "'div'", "'begin'", "'end'", "')'", "'and'", 
		"'not'", "'=/='", "'-'", "TokAtom", "TokVar", "TokFloat", "TokInteger", 
	...
	public final FormsContext forms() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 63)) & ~0x3f) == 0 && ((1L << (_la - 63)) & ((1L << (T__0 - 63)) | (1L << (TokAtom - 63)) | (1L << (AttrName - 63)))) != 0) );
	...
	public final FormContext form() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(209); attribute();
				}
				break;
			case 2:
				{
				setState(210); function();
				}
				break;
			case 3:
				{
				setState(211); ruleClauses();
				}
				break;
			}
	...
	public final AttributeContext attribute() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(229); tokAtom();
				setState(230); attrVal();
				}
				break;
			case 2:
				...
				setState(233); tokAtom();
				setState(234); typedAttrVal();
				}
				break;
			case 3:
				...
				setState(237); tokAtom();
				setState(238); match(T__49);
				setState(239); typedAttrVal();
			...
			case 4:
				...
				{
				setState(242); match(AttrName);
				setState(243); typeSpec();
				}
				break;
			}
		}
	...
	public final TypeSpecContext typeSpec() throws RecognitionException {
		...
		try {
			...
			case TokAtom:
				enterOuterAlt(_localctx, 1);
				{
				setState(246); specFun();
				setState(247); typeSigs();
				}
				break;
			case T__49:
				enterOuterAlt(_localctx, 2);
				{
				setState(249); match(T__49);
				setState(250); specFun();
				setState(251); typeSigs();
	...
	public final SpecFunContext specFun() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(256); tokAtom();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(257); tokAtom();
				setState(258); match(T__16);
				setState(259); tokAtom();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(261); tokAtom();
				setState(262); match(T__35);
				setState(263); tokInteger();
				setState(264); match(T__54);
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(266); tokAtom();
				setState(267); match(T__16);
				setState(268); tokAtom();
				setState(269); match(T__35);
				setState(270); tokInteger();
				setState(271); match(T__54);
				}
				break;
			}
		}
	...
	public final TypedAttrValContext typedAttrVal() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(277); typedRecordFields();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(279); expr();
				setState(280); match(T__54);
				setState(281); topType();
				}
				break;
			}
		}
	...
	public final TypedRecordFieldsContext typedRecordFields() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(285); match(T__57);
			setState(286); typedExprs();
	...
	public final TypedExprsContext typedExprs() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(289); typedExpr();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(290); typedExpr();
				setState(291); match(T__48);
				setState(292); typedExprs();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				...
				setState(296); typedExprs();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(298); typedExpr();
				setState(299); match(T__48);
				setState(300); exprs();
				}
				break;
			}
	...
	public final TypeSigContext typeSig() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(316); funType();
			setState(319);
			_la = _input.LA(1);
			if (_la==T__24) {
				{
				setState(317); match(T__24);
				setState(318); typeGuards();
				}
			}
	...
	public final TypeGuardsContext typeGuards() throws RecognitionException {
		...
		try {
			...
			while (_la==T__48) {
				{
				{
				setState(322); match(T__48);
				setState(323); typeGuard();
				}
				}
				setState(328);
				_errHandler.sync(this);
	...
	public final TypeGuardContext typeGuard() throws RecognitionException {
		...
		try {
			...
			case TokAtom:
				enterOuterAlt(_localctx, 1);
				{
				setState(329); tokAtom();
				setState(330); match(T__49);
				setState(331); topTypes();
			...
			case TokVar:
				...
				{
				setState(334); tokVar();
				setState(335); match(T__54);
				setState(336); topType();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final TopTypeContext topType() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(348); tokVar();
				setState(349); match(T__54);
				}
				break;
			}
			setState(353); topType100();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final TopType100Context topType100() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(355); type200();
			setState(358);
			_la = _input.LA(1);
			if (_la==T__12) {
				{
				setState(356); match(T__12);
				setState(357); topType100();
				}
			}
	...
	public final Type200Context type200() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(360); type300(0);
			setState(363);
			_la = _input.LA(1);
			if (_la==T__55) {
				{
				setState(361); match(T__55);
				setState(362); type300(0);
				}
			}
	...
	public final Type500Context type500() throws RecognitionException {
		...
		try {
			...
			setState(390);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__51) | (1L << T__36) | (1L << T__2) | (1L << T__0))) != 0)) {
				{
				setState(389); prefixOp();
				}
			}
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(394); match(T__49);
				setState(395); topType();
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(399); tokAtom();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(400); tokAtom();
				setState(401); match(T__49);
				setState(402); match(T__4);
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(404); tokAtom();
				setState(405); match(T__49);
				setState(406); topTypes();
				setState(407); match(T__4);
				}
				break;
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(409); tokAtom();
				setState(410); match(T__16);
				setState(411); tokAtom();
				setState(412); match(T__49);
				setState(413); match(T__4);
				}
				break;
			case 7:
				enterOuterAlt(_localctx, 7);
				{
				setState(415); tokAtom();
				setState(416); match(T__16);
				setState(417); tokAtom();
				setState(418); match(T__49);
				setState(419); topTypes();
			...
			case 9:
				...
				setState(425); topType();
				setState(426); match(T__39);
				}
				break;
			case 10:
				...
				setState(429); topType();
				setState(430); match(T__48);
				setState(431); match(T__17);
				setState(432); match(T__39);
				}
				break;
			case 11:
				enterOuterAlt(_localctx, 11);
				{
				setState(434); match(T__57);
			...
			case 12:
				...
				{
				setState(436); match(T__57);
				setState(437); topTypes();
			...
			case 13:
				...
				setState(441); tokAtom();
				setState(442); match(T__57);
			...
			case 14:
				...
				{
				setState(445); match(T__37);
				setState(446); tokAtom();
				setState(447); match(T__57);
				setState(448); fieldTypes();
			...
			case 15:
				...
				{
				setState(451); binaryType();
				}
				break;
			case 16:
				enterOuterAlt(_localctx, 16);
				{
				setState(452); tokInteger();
				}
				break;
			case 17:
				enterOuterAlt(_localctx, 17);
				{
				setState(453); match(T__60);
				setState(454); match(T__49);
			...
			case 18:
				...
				{
				setState(456); match(T__60);
				setState(457); match(T__49);
				setState(458); funType100();
				setState(459); match(T__4);
				}
				break;
			}
		}
	...
	public final FunType100Context funType100() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(463); match(T__49);
				setState(464); match(T__17);
				setState(465); match(T__4);
				setState(466); match(T__18);
				setState(467); topType();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(468); funType();
				}
				break;
			}
		}
	...
	public final FunTypeContext funType() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(471); match(T__49);
			setState(473);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__60) | (1L << T__57) | (1L << T__51) | (1L << T__49) | (1L << T__37) | (1L << T__36) | (1L << T__30) | (1L << T__15) | (1L << T__2) | (1L << T__0))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (TokAtom - 64)) | (1L << (TokVar - 64)) | (1L << (TokInteger - 64)))) != 0)) {
				{
				setState(472); topTypes();
				}
			}

			setState(475); match(T__4);
			setState(476); match(T__18);
			setState(477); topType();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FieldTypeContext fieldType() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(487); tokAtom();
			setState(488); match(T__54);
			setState(489); topType();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BinaryTypeContext binaryType() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(491); match(T__30);
				setState(492); match(T__56);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(494); binBaseType();
				setState(495); match(T__56);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(497); match(T__30);
				setState(498); binUnitType();
				setState(499); match(T__56);
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(501); match(T__30);
				setState(502); binBaseType();
				setState(503); match(T__48);
				setState(504); binUnitType();
				setState(505); match(T__56);
				}
				break;
			}
		}
	...
	public final BinUnitTypeContext binUnitType() throws RecognitionException {
		...
		try {
			...
			{
			setState(513); tokVar();
			setState(514); match(T__16);
			setState(515); tokVar();
			setState(516); match(T__22);
			setState(517); type();
			}
		}
		catch (RecognitionException re) {
	...
	public final AttrValContext attrVal() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				setState(529); expr();
				setState(530); match(T__48);
				setState(531); exprs();
				setState(532); match(T__4);
				}
				break;
			}
		}
	...
	public final FunctionContext function() throws RecognitionException {
		...
		try {
			...
			while (_la==T__31) {
				{
				{
				setState(537); match(T__31);
				setState(538); functionClause();
				}
				}
				setState(543);
				_errHandler.sync(this);
	...
	public final FunctionClauseContext functionClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(544); tokAtom();
			setState(545); clauseArgs();
			setState(546); clauseGuard();
			setState(547); clauseBody();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Expr100Context expr100() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(563); expr150();
			setState(568);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__53 || _la==T__8) {
				{
				{
				setState(564);
				_la = _input.LA(1);
				if ( !(_la==T__53 || _la==T__8) ) {
				_errHandler.recoverInline(this);
				}
				consume();
				setState(565); expr150();
				}
				}
				setState(570);
				_errHandler.sync(this);
	...
	public final Expr150Context expr150() throws RecognitionException {
		...
		try {
			...
			while (_la==T__50) {
				{
				{
				setState(572); match(T__50);
				setState(573); expr160();
				}
				}
				setState(578);
				_errHandler.sync(this);
	...
	public final Expr160Context expr160() throws RecognitionException {
		...
		try {
			...
			while (_la==T__23) {
				{
				{
				setState(580); match(T__23);
				setState(581); expr200();
				}
				}
				setState(586);
				_errHandler.sync(this);
	...
	public final Expr200Context expr200() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(587); expr300();
			setState(591);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__59) | (1L << T__47) | (1L << T__42) | (1L << T__41) | (1L << T__38) | (1L << T__14) | (1L << T__11) | (1L << T__1))) != 0)) {
				{
				setState(588); compOp();
				setState(589); expr300();
				}
			}
	...
	public final Expr400Context expr400() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(602); expr500();
			setState(608);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__62) | (1L << T__61) | (1L << T__52) | (1L << T__36) | (1L << T__21) | (1L << T__10) | (1L << T__9) | (1L << T__0))) != 0)) {
				{
				{
				setState(603); addOp();
				setState(604); expr500();
				}
				}
				setState(610);
				_errHandler.sync(this);
	...
	public final Expr500Context expr500() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(611); expr600();
			setState(617);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__43) | (1L << T__35) | (1L << T__26) | (1L << T__22) | (1L << T__7) | (1L << T__3))) != 0)) {
				{
				{
				setState(612); multOp();
				setState(613); expr600();
				}
				}
				setState(619);
				_errHandler.sync(this);
	...
	public final Expr600Context expr600() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__51) | (1L << T__36) | (1L << T__2) | (1L << T__0))) != 0)) {
				{
				setState(620); prefixOp();
				}
			}

			setState(623); expr700();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Expr700Context expr700() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(625); functionCall();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(626); recordExpr(0);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(627); expr800();
				}
				break;
			}
		}
	...
	public final Expr800Context expr800() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(630); exprMax();
			setState(633);
			_la = _input.LA(1);
			if (_la==T__16) {
				{
				setState(631); match(T__16);
				setState(632); exprMax();
				}
			}
	...
	public final ExprMaxContext exprMax() throws RecognitionException {
		...
		try {
			...
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(639); listComprehension();
				}
				break;
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(640); binaryComprehension();
				}
				break;
			case 7:
				enterOuterAlt(_localctx, 7);
			...
			case 8:
				enterOuterAlt(_localctx, 8);
				{
				setState(642); match(T__49);
				setState(643); expr();
				setState(644); match(T__4);
				}
				break;
			case 9:
				enterOuterAlt(_localctx, 9);
			...
			case 11:
				enterOuterAlt(_localctx, 11);
				{
				setState(651); caseExpr();
				}
				break;
			case 12:
				enterOuterAlt(_localctx, 12);
				{
				setState(652); receiveExpr();
				}
				break;
			case 13:
				enterOuterAlt(_localctx, 13);
				{
				setState(653); funExpr();
				}
				break;
			case 14:
				enterOuterAlt(_localctx, 14);
				{
				setState(654); tryExpr();
				}
				break;
			}
		}
	...
	public final ListContext list() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(657); match(T__15);
				setState(658); match(T__39);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(659); match(T__15);
				setState(660); expr();
				setState(661); tail();
				}
				break;
	...
	public final TailContext tail() throws RecognitionException {
		...
		try {
			...
			case T__39:
				enterOuterAlt(_localctx, 1);
				{
				setState(665); match(T__39);
				}
				break;
			case T__12:
				enterOuterAlt(_localctx, 2);
				{
				setState(666); match(T__12);
				setState(667); expr();
				setState(668); match(T__39);
				}
				break;
			case T__48:
				enterOuterAlt(_localctx, 3);
				{
				setState(670); match(T__48);
				setState(671); expr();
				setState(672); tail();
				}
				break;
	...
	public final BinaryContext binary() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(676); match(T__30);
				setState(677); match(T__56);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(678); match(T__30);
				setState(679); binElements();
				setState(680); match(T__56);
				}
				break;
			}
		}
	...
	public final BinElementsContext binElements() throws RecognitionException {
		...
		try {
			...
			while (_la==T__48) {
				{
				{
				setState(685); match(T__48);
				setState(686); binElement();
				}
				}
				setState(691);
				_errHandler.sync(this);
	...
	public final BinElementContext binElement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(692); bitExpr();
			setState(693); optBitSizeExpr();
			setState(694); optBitTypeList();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BitExprContext bitExpr() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__51) | (1L << T__36) | (1L << T__2) | (1L << T__0))) != 0)) {
				{
				setState(696); prefixOp();
				}
			}

			setState(699); exprMax();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OptBitSizeExprContext optBitSizeExpr() throws RecognitionException {
		...
		try {
			...
			if (_la==T__16) {
				{
				setState(701); match(T__16);
				setState(702); bitSizeExpr();
				}
			}
	...
	public final OptBitTypeListContext optBitTypeList() throws RecognitionException {
		...
		try {
			...
			if (_la==T__35) {
				{
				setState(705); match(T__35);
				setState(706); bitTypeList();
				}
			}
	...
	public final BitTypeListContext bitTypeList() throws RecognitionException {
		...
		try {
			...
			while (_la==T__0) {
				{
				{
				setState(710); match(T__0);
				setState(711); bitType();
				}
				}
				setState(716);
				_errHandler.sync(this);
	...
	public final BitTypeContext bitType() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(717); tokAtom();
			setState(720);
			_la = _input.LA(1);
			if (_la==T__16) {
				{
				setState(718); match(T__16);
				setState(719); tokInteger();
				}
			}
	...
	public final ListComprehensionContext listComprehension() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(724); match(T__15);
			setState(725); expr();
			setState(726); match(T__32);
			setState(727); lcExprs();
			setState(728); match(T__39);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BinaryComprehensionContext binaryComprehension() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(730); match(T__30);
			setState(731); binary();
			setState(732); match(T__32);
			setState(733); lcExprs();
			setState(734); match(T__56);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final TupleContext tuple() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(755); match(T__57);
			setState(757);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__60) | (1L << T__58) | (1L << T__57) | (1L << T__51) | (1L << T__49) | (1L << T__37) | (1L << T__36) | (1L << T__34) | (1L << T__30) | (1L << T__28) | (1L << T__27) | (1L << T__19) | (1L << T__15) | (1L << T__6) | (1L << T__2) | (1L << T__0))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (TokAtom - 64)) | (1L << (TokVar - 64)) | (1L << (TokFloat - 64)) | (1L << (TokInteger - 64)) | (1L << (TokChar - 64)) | (1L << (TokString - 64)))) != 0)) {
				{
				setState(756); exprs();
				}
			}

			setState(759); match(T__29);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private RecordExprContext recordExpr(int _p) throws RecognitionException {
		...
		try {
			...
			setState(763);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__60) | (1L << T__58) | (1L << T__57) | (1L << T__49) | (1L << T__30) | (1L << T__28) | (1L << T__27) | (1L << T__19) | (1L << T__15) | (1L << T__6))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (TokAtom - 64)) | (1L << (TokVar - 64)) | (1L << (TokFloat - 64)) | (1L << (TokInteger - 64)) | (1L << (TokChar - 64)) | (1L << (TokString - 64)))) != 0)) {
				{
				setState(762); exprMax();
				}
			}

			setState(765); match(T__37);
			setState(766); tokAtom();
			setState(770);
			switch (_input.LA(1)) {
			case T__20:
				{
				setState(767); match(T__20);
				setState(768); tokAtom();
				}
				break;
			case T__57:
				{
				setState(769); recordTuple();
				}
				break;
			default:
				throw new NoViableAltException(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(773); match(T__37);
					setState(774); tokAtom();
					setState(778);
					switch (_input.LA(1)) {
					case T__20:
						{
						setState(775); match(T__20);
						setState(776); tokAtom();
						}
						break;
					case T__57:
						{
						setState(777); recordTuple();
						}
						break;
					default:
						throw new NoViableAltException(this);
	...
	public final RecordTupleContext recordTuple() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(785); match(T__57);
			setState(787);
			_la = _input.LA(1);
			if (_la==TokAtom || _la==TokVar) {
				{
				setState(786); recordFields();
				}
			}

			setState(789); match(T__29);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final RecordFieldsContext recordFields() throws RecognitionException {
		...
		try {
			...
			while (_la==T__48) {
				{
				{
				setState(792); match(T__48);
				setState(793); recordField();
				}
				}
				setState(798);
				_errHandler.sync(this);
	...
	public final RecordFieldContext recordField() throws RecognitionException {
		...
		try {
			...
			case TokAtom:
				{
				setState(800); tokAtom();
				}
				break;
			default:
				throw new NoViableAltException(this);
			}
			setState(803); match(T__53);
			setState(804); expr();
			}
		}
		catch (RecognitionException re) {
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(806); expr800();
			setState(807); argumentList();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final IfExprContext ifExpr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(809); match(T__28);
			setState(810); ifClauses();
	...
	public final IfClausesContext ifClauses() throws RecognitionException {
		...
		try {
			...
			while (_la==T__31) {
				{
				{
				setState(814); match(T__31);
				setState(815); ifClause();
				}
				}
				setState(820);
				_errHandler.sync(this);
	...
	public final CaseExprContext caseExpr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(824); match(T__19);
			setState(825); expr();
			setState(826); match(T__33);
			setState(827); crClauses();
			setState(828); match(T__5);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final CrClausesContext crClauses() throws RecognitionException {
		...
		try {
			...
			while (_la==T__31) {
				{
				{
				setState(831); match(T__31);
				setState(832); crClause();
				}
				}
				setState(837);
				_errHandler.sync(this);
	...
	public final CrClauseContext crClause() throws RecognitionException {
		...
		try {
			...
			{
			setState(838); expr();
			setState(839); clauseGuard();
			setState(840); clauseBody();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ReceiveExprContext receiveExpr() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(842); match(T__58);
				setState(843); crClauses();
				setState(844); match(T__5);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(846); match(T__58);
				setState(847); match(T__45);
				setState(848); expr();
				setState(849); clauseBody();
				setState(850); match(T__5);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(852); match(T__58);
				setState(853); crClauses();
				setState(854); match(T__45);
				setState(855); expr();
				setState(856); clauseBody();
				setState(857); match(T__5);
				}
				break;
			}
		}
	...
	public final FunExprContext funExpr() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(862); tokAtom();
				setState(863); match(T__35);
				setState(864); tokInteger();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(867); atomOrVar();
				setState(868); match(T__16);
				setState(869); atomOrVar();
				setState(870); match(T__35);
				setState(871); integerOrVar();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(873); match(T__60);
				setState(874); funClauses();
				setState(875); match(T__5);
				}
				break;
			}
		}
	...
	public final FunClausesContext funClauses() throws RecognitionException {
		...
		try {
			...
			while (_la==T__31) {
				{
				{
				setState(888); match(T__31);
				setState(889); funClause();
				}
				}
				setState(894);
				_errHandler.sync(this);
	...
	public final FunClauseContext funClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(895); argumentList();
			setState(896); clauseGuard();
			setState(897); clauseBody();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final TryExprContext tryExpr() throws RecognitionException {
		...
		try {
			...
			if (_la==T__33) {
				{
				setState(901); match(T__33);
				setState(902); crClauses();
				}
			}

			setState(905); tryCatch();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final TryCatchContext tryCatch() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(907); match(T__34);
				setState(908); tryClauses();
				setState(909); match(T__5);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(911); match(T__34);
				setState(912); tryClauses();
				setState(913); match(T__45);
				setState(914); exprs();
				setState(915); match(T__5);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
	...
	public final TryClausesContext tryClauses() throws RecognitionException {
		...
		try {
			...
			while (_la==T__31) {
				{
				{
				setState(924); match(T__31);
				setState(925); tryClause();
				}
				}
				setState(930);
				_errHandler.sync(this);
	...
	public final TryClauseContext tryClause() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(931); atomOrVar();
				setState(932); match(T__16);
				}
				break;
			}
			setState(936); expr();
			setState(937); clauseGuard();
			setState(938); clauseBody();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AtomicContext atomic() throws RecognitionException {
		...
		try {
			...
			case TokChar:
				enterOuterAlt(_localctx, 1);
				{
				setState(962); tokChar();
				}
				break;
			case TokInteger:
				enterOuterAlt(_localctx, 2);
				{
				setState(963); tokInteger();
				}
				break;
			case TokFloat:
				enterOuterAlt(_localctx, 3);
				{
				setState(964); tokFloat();
				}
				break;
			case TokAtom:
				enterOuterAlt(_localctx, 4);
				{
				setState(965); tokAtom();
				}
				break;
			case TokString:
				enterOuterAlt(_localctx, 5);
	...
	public final MultOpContext multOp() throws RecognitionException {
		...
		try {
			...
			setState(975);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__43) | (1L << T__35) | (1L << T__26) | (1L << T__22) | (1L << T__7) | (1L << T__3))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public final AddOpContext addOp() throws RecognitionException {
		...
		try {
			...
			setState(977);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__62) | (1L << T__61) | (1L << T__52) | (1L << T__36) | (1L << T__21) | (1L << T__10) | (1L << T__9) | (1L << T__0))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public final RuleClausesContext ruleClauses() throws RecognitionException {
		...
		try {
			...
			while (_la==T__31) {
				{
				{
				setState(984); match(T__31);
				setState(985); ruleClause();
				}
				}
				setState(990);
				_errHandler.sync(this);
	...
	public final RuleClauseContext ruleClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(991); tokAtom();
			setState(992); clauseArgs();
			setState(993); clauseGuard();
			setState(994); ruleBody();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final RuleBodyContext ruleBody() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState